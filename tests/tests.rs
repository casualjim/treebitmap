...
fn supernets_v6() {
  let mut tbm = IpLookupTable::new();
  tbm.insert(Ipv6Addr::new(0x2600, 0x1f18, 0x631e, 0x2f00, 0x6a66, 934, 0xa406, 0xb569), 128, 1000002);
  tbm.insert(Ipv6Addr::new(0x2600, 0x1f18, 0x631e, 0x2f00, 0x6a66, 934, 0xa406, 0), 112, 1000044);
  tbm.insert(Ipv6Addr::new(0x2600, 0x1f18, 0x631e, 0x2f00, 0x6a66, 934, 0, 0), 96, 1000555);
  tbm.insert(Ipv6Addr::new(0x2600, 0x1f18, 0x631e, 0x2f00, 0x6a66, 934, 0xa406, 0xba00), 128, 1000009);
  tbm.insert(Ipv6Addr::new(0x2600, 0x1f18, 0x631e, 0x2f00, 0x6a66, 0, 0, 0), 80, 1006666);
  tbm.insert(Ipv6Addr::new(0x2600, 0x1f18, 0x631e, 0x2f00, 0, 0, 0, 0), 64, 1077777);

  let result = tbm.supernets(Ipv6Addr::new(0x2600, 0x1f18, 0x631e, 0x2f00, 0x6a66, 934, 0xa406, 0xb569), 128);
  assert_eq!(result, vec![
    (Ipv6Addr::new(0x2600, 0x1f18, 0x631e, 0x2f00, 0, 0, 0, 0), 64, &1077777),
    (Ipv6Addr::new(0x2600, 0x1f18, 0x631e, 0x2f00, 0x6a66, 0, 0, 0), 80, &1006666),
    (Ipv6Addr::new(0x2600, 0x1f18, 0x631e, 0x2f00, 0x6a66, 934, 0, 0), 96, &1000555),
    (Ipv6Addr::new(0x2600, 0x1f18, 0x631e, 0x2f00, 0x6a66, 934, 0xa406, 0), 112, &1000044),
    (Ipv6Addr::new(0x2600, 0x1f18, 0x631e, 0x2f00, 0x6a66, 934, 0xa406, 0xb569), 128, &1000002),
  ]);
}
